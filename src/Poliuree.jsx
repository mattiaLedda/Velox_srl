...
import MobileMidPoli from "./MobileMidPoli"
import MobileHalfPicture from "./MobileHalfPicture"
...
function Poliuree() {
    return (
        <div>
            ...
            <div id="mobilethreepar">
                <MobileThreePar icon={threeparag.first.icon} title={threeparag.first.title} text={threeparag.first.text} />
            </div>
            <div id="midpolipc">
                <MidPoli />
            </div>
            <div id="midpolimobile">
                <MobileMidPoli />
            </div>
            <div id="pchalfpic">
                <HalfPicture />
            </div>
            <div id="mobilehalfpic">
                <MobileHalfPicture />
            </div>
